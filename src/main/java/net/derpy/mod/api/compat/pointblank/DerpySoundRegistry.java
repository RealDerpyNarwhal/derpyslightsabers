...
public class DerpySoundRegistry {
    ...
    public static Supplier<SoundEvent> BLASTERRELOAD = register("blasterreload");
    ...
    public static final Supplier<SoundEvent> register(String sound) {
        Supplier<SoundEvent> registeredSound = soundRegistry.register(sound, () -> {
            return SoundEvent.of(new Identifier("pointblank", sound));
        });
